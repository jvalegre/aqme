...
def parser_args():
	...
	parser.add_argument("--cpcm_input_sp",default=[], help="Additional lines for ORCA single-point calculations in the cpcm section", dest="cpcm_input_sp", type=str, nargs='?')
	parser.add_argument("--orca_scf_iters_sp",default=[], help="Number of SCF iterations in ORCA single-point calculations", dest="orca_scf_iters_sp", type=str, nargs='?')
	...
	parser.add_argument("--set_input_line_sp", help="Extra keywords for ORCA single-point calculations", default="None", dest="set_input_line_sp")
