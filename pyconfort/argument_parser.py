...
def parser_args():
	...
	# parser.add_argument("--nmr_intercept",help="Specify the intercept for each nucleus for nmr analysis default([-15.191,-2.2094])", default=[1.0673,1.0759], dest="nmr_intercept", type=float, nargs='*')
	# parser.add_argument("--nmr_tms_ref",help="Specify the reference for TMS for each nucleus for nmr analysis default([189.504625,31.56496667])", default=[0.0,0.0], dest="nmr_tms_ref", type=float, nargs='*')
