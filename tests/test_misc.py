...
[
    ...
    # test if the program removes the *_rdkit.sdf files when using dihedral scans
    ('pentane.smi', 'params_test15.yaml', 0, 1, 'count_sdf'), # test dihedral scan
    # test the lowest_only option from SDF files and from the conformer generator workflow
    ('pentane.smi', 'params_test_misc1.yaml', 1, 'nan', 'count_com'), # test lowest_only with dihedral scan
    ('pentane.smi', 'params_test_misc2.yaml', 1, 'nan', 'count_com'), # test lowest_only with no dihedral scan
    ('pentane_n_lowest.sdf', 'params_test_misc3.yaml', 1, 'nan', 'count_com'), # test lowest_only with no dihedral scan
    # test the lowest_n option from SDF files and from the conformer generator workflow
    ('pentane.smi', 'params_test_misc4.yaml', 2, 'nan', 'count_com'), # test n_lowest with dihedral scan
    ('pentane.smi', 'params_test_misc5.yaml', 2, 'nan', 'count_com'), # test n_lowest with no dihedral scan
    ('pentane_n_lowest.sdf', 'params_test_misc6.yaml', 2, 'nan', 'count_com'), # test n_lowest with no dihedral scan
    ...
    ('pentane.smi', 'params_test_misc10.yaml', 1, 'nan', 'multiple_lot'), # test multiple levels of theory
    ('pentane.smi', 'params_test_misc11.yaml', 1, 1, 'multiple_lot'), # test multiple levels of theory and genecp
    # test for checking write_gauss=False
    ('pentane.smi', 'params_test_misc12.yaml', 0, 1, 'no_com_files'), # test gauss_write=False
])
...
def test_confgen_misc(smiles, params_file, goal, goal_2, job_type):
    ...
    if job_type == 'count_sdf':
        ...
        # First goal: countes the number of *_rdkit.sdf files created
    ...
    if job_type == 'freq_maxcycles':
        ...
        # Should find opt=(maxcycles=225) in the keyword line of the COM file (test_goal should be 0)
