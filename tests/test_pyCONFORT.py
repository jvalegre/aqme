...
[
    ...
    ('Ag_Au_complex.smi', 'params_Ag_Au_test1.yaml', 360, 352, 0, [-5.26093, -4.41687, -4.39313, -4.10961, -3.93585, -2.95568, -2.43353, -2.03709, -1.51856, -1.45757, -0.22202, 0.46406], 0, False), # test 2 metals with genecp
    ...
    ('Pd_squareplanar.smi', 'params_Pd_test1.yaml', 360, 349, 0, [6.14954, 6.15497, 6.20729, 6.3288, 6.35036, 6.35559, 6.35893, 6.52387, 6.56902], 0, False), # test squareplanar template with gen
    ('Rh_squareplanar.smi', 'params_Rh_test1.yaml', 360, 111, 0, [6.14954, 6.15497, 6.20729, 6.3288, 6.35036, 6.35559, 6.35893, 6.52387, 6.56902], 0, False), # test squareplanar template with gen
])
