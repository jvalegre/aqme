...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "z_CH4_duplicate.log",
            None,
            "unsuccessful_QM_outputs/run_1/duplicates",
            False,
        ),  # test duplicates
        (
            "QCORR_1",
            ...
            None,
            "unsuccessful_QM_outputs/run_1/error/basis_set_error",
            False,
        ...
        (
            ...
            "MeOH_G09_FAIL.log",
            None,
            "unsuccessful_QM_outputs/run_1/error/not_specified_error",
            False,
        ...
        (
            ...
            "Imag_freq.log",
            None,
            "unsuccessful_QM_outputs/run_1/extra_imag_freq",
            False,
        ...
        (
            ...
            "MeOH_SCF_error.log",
            None,
            "unsuccessful_QM_outputs/run_1/error/scf_error",
            False,
        ),  # test SCF errors
        (
            "QCORR_1",
            "CH4_before_E.log",
            None,
            "unsuccessful_QM_outputs/run_1/error/no_data",
            False,
        ...
        (
            ...
            "freq_conv_YYNN.log",
            None,
            "unsuccessful_QM_outputs/run_1/freq_no_conv",
            False,
        ...
        (
            ...
            None,
            "unsuccessful_QM_outputs/run_1/spin_contaminated",
            False,
        ...
        (
            ...
            None,
            "unsuccessful_QM_outputs/run_1/ts_no_imag_freq",
            False,
        ),  # test imaginary frequencies for TSs
        (
            "QCORR_1",
            "CH4_SP.log",
            None,
            "successful_QM_outputs/SP_calcs",
            False,
        ...
        (
            ...
            None,
            "unsuccessful_QM_outputs/run_1/linear_mol_wrong",
            False,
        ...
        (
            ...
            "json",
            None,
            "successful_QM_outputs/json_files",
            False,
        ...
        (
            ...
            None,
            "unsuccessful_QM_outputs/run_1/isomerization",
            False,
...
def test_QCORR_analysis(init_folder, file, command_line, target_folder, restore_folder):
    ...
    if init_folder == "QCORR_1":
        ...
        if file.split(".")[-1].lower() == "log":
            ...
            if file.split(".")[0] in [
                ...
                assert not path.exists(
                    f'{w_dir_main}/unsuccessful_QM_outputs/run_1/fixed_QM_inputs/{file.split(".")[0]}.com'
                )
        ...
        # ensure that no com files were generated
            ...
            assert not path.exists(
                f"{w_dir_main}/unsuccessful_QM_outputs/run_1/fixed_QM_inputs/"
            )
        ...
        w_dir_QCORR_5 = (
            f"{path_qcorr}/{init_folder}/unsuccessful_QM_outputs/run_1/fixed_QM_inputs/"
        )
        ...
        if file.split(".")[0] == "CH4":
            ...
            assert not path.exists(
                f"{w_dir_main}/{target_folder}/run_1/fixed_QM_inputs/unsuccessful_QM_outputs"
            )

    elif init_folder == "QCORR_5b":
        w_dir_QCORR_5b = f"{path_qcorr}/QCORR_5"
        file_QCORR_5b = Path(
            f"{w_dir_QCORR_5b}/unsuccessful_QM_outputs/run_1/fixed_QM_inputs/{file}"
        )
        ...
        if command_line is not None:
            ...
            cmd_aqme = cmd_aqme + [
                ...
                "gjf",
                "--isom_inputs",
                w_dir_QCORR_5b + "/unsuccessful_QM_outputs/run_1/fixed_QM_inputs/",
            ]
            subprocess.run(cmd_aqme)
        ...
        if file.split(".")[0] == "CH4":
            ...
            assert not path.exists(
                f"{w_dir_QCORR_5b}/{target_folder}/run_1/fixed_QM_inputs/unsuccessful_QM_outputs"
            )
