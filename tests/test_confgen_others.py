...
[
    ...
    ('Input_files', 'charged.com', 'params_format_test3.yaml', 20, 19, 0, [-252.7254], 1, 1, False, False, False, False), # test com with charge 1
    ('Input_files', 'charged.gjf', 'params_format_test4.yaml', 20, 19, 0, [-252.7254], -1, 1, False, False, False, False), # test gjf with charge -1
    ...
    ('Multiple', 'pentane_Pd.smi', 'params_comb_test5.yaml', 27, 'nan', 4, [-5.27175,-4.44184,-3.84858,-1.57172], 0, 1, True, False, False, False), # test pentane + Pd + dihedral
])
