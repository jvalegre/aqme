...
python /projects/myscripts/db_gen.py --compute --input $0
...
python /projects/myscripts/db_gen.py --analysis --path $(PWD)/gaussian/

##resubmit the gaussian jobs if the didnt normally terminate
python /projects/myscripts/db_gen.py --resubmit --path $(PWD)/gaussian/

##once resubmission is completed analyse the NEWLY CREATED Files and moves the normally terminated to the finished folder
python /projects/myscripts/db_gen.py --analysis --secondrun --path $(PWD)/gaussian/
...
python /projects/myscripts/db_gen.py --boltz --path $(PWD)/gaussian/

##combing all the energies for all molecules and printing the output in one csv_file
python /projects/myscripts/db_gen.py --combine --path $(PWD)/gaussian/
